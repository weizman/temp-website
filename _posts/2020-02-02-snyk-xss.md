...
enabled: true
layout: post
tags: Discovery,Browser,Top,CVEs,Vulnerabilities,Security,JavaScript,Research,Published,Posts,Supply-Chain-Security
...
[Original Vulnerability Disclosure Report 📝](https://github.com/weizman/CVE-2023-1767/blob/main/report) | [Exploit PoC 💻](https://github.com/weizman/CVE-2023-1767/blob/main/demo)
...
![GPT describing how to vet a package, the full list of methods is below in the rest of the blog post](./gpt.png)
...
Since it's already fixed by now, you can see it before it was fixed by visiting the official [Vulnerability report as sent to Snyk](../report/) I handed Snyk.
...
([package.json](../demo/png2jpg/package.json))
...
([index.js](../demo/png2jpg/index.js))
...
([README.md](../demo/png2jpg/README.md))
...
([payload.js](../demo/README.md#malicious-js-payload))
